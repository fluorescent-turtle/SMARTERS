...
def begin_simulation(tassel_dim, repetitions, cycle):
    ...
    isolated_area_tassels = []
    grid, resources = create_random_grid(
        environment_data, tassel_dim, isolated_area_tassels
    )
    ...
    # todo: controlla che isolated_area_tassels non sia vuoto, ma che lo abbia riempieto
